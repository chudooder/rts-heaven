...
public class Renderer {
	...
	public static void render(Texture t, float x, float y, float depth) {
		render(t, 0, 0, 1, 1, x, y, x+t.getImageWidth(), y+t.getImageHeight(), depth, null, new ShaderArgs());
	}
	
	public static void render(Texture t, float x, float y, float depth, Transform transform) {
		render(t, 0, 0, 1, 1, x, y, x+t.getImageWidth(), y+t.getImageHeight(), depth, transform, new ShaderArgs());
	}
    ...
    */
    ...
    private static int createProgram(String vertShader, String fragShader) {
	    ...
	    int loc = GL20.glGetUniformLocation(prog, "texture0");
        GL20.glUniform1i(loc, 0);
        int loc2 = GL20.glGetUniformLocation(prog, "texture1");
