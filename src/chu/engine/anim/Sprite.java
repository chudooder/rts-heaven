...
public class Sprite {
	...
	public void render(float x, float y, float depth, Transform t, ShaderArgs args) {
		if(currentAnimation == null) return;
		...
		Renderer.render(texture, x0, 0, x1, 1, (int)x, (int)y, (int)x+width, (int)y+height, depth, t, args);
	}
